...
#define BAUDIOS 118 //define tiempo para uart funcione de manera correcta es 1/baudios en realidad
#define BAUDIOS_R 114 // define tiempo uart para RX os 
#define BAUDIOS_S 100 
