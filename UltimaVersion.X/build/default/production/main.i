...
void main(void) {
    ...
    while(1){
         switch(state) {
            ...
            case F1K:
                GPIO5 ^= 1;
                _delay((unsigned long)((32*16)*(4000000/4000000.0)));
                break;
            case F2K:
                GPIO5 ^= 1;
                _delay((unsigned long)((32*8)*(4000000/4000000.0)));
            break;
            case F4K:
                GPIO5 ^= 1;
                _delay((unsigned long)((32*4)*(4000000/4000000.0)));
               break;
            case F8K:
                GPIO5 ^= 1;
                _delay((unsigned long)((32*2)*(4000000/4000000.0)));
                break;
             case F16K:
                GPIO5 ^= 1;
